...
const EMBEDDED_METHODS: MethodEntry[] = [
  {
    ...
    "perLanguage": {
      ...
      "ruby": {
        "method": "namespaces",
        "example": "require \"turbopuffer\"\n\nturbopuffer = Turbopuffer::Client.new(api_key: \"tpuf_A1...\")\n\npage = turbopuffer.namespaces\n\nputs(page)"
      },
      "http": {
        "example": "curl https://$TURBOPUFFER_REGION.turbopuffer.com/v1/namespaces \\\n    -H \"Authorization: Bearer $TURBOPUFFER_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://$TURBOPUFFER_REGION.turbopuffer.com/v2/namespaces/$NAMESPACE \\\n    -X POST \\\n    -H \"Authorization: Bearer $TURBOPUFFER_API_KEY\" \\\n    --retry 6"
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://$TURBOPUFFER_REGION.turbopuffer.com/v2/namespaces/$NAMESPACE/query \\\n    -X POST \\\n    -H \"Authorization: Bearer $TURBOPUFFER_API_KEY\""
      }
    }
  },
  {
    ...
    "params": [
      "namespace: string;",
      "queries: { aggregate_by?: object; distance_metric?: 'cosine_distance' | 'euclidean_squared'; exclude_attributes?: string[]; filters?: object; group_by?: string[]; include_attributes?: boolean | string[]; limit?: number | { total: number; per?: { attributes: string[]; limit: number; }; }; rank_by?: object; top_k?: number; }[];",
      "consistency?: { level?: 'strong' | 'eventual'; };",
      "vector_encoding?: 'float' | 'base64';"
    ],
    ...
    "markdown": "## multi_query\n\n`client.namespaces.multiQuery(namespace: string, queries: { aggregate_by?: object; distance_metric?: 'cosine_distance' | 'euclidean_squared'; exclude_attributes?: string[]; filters?: object; group_by?: string[]; include_attributes?: boolean | string[]; limit?: number | object; rank_by?: object; top_k?: number; }[], consistency?: { level?: 'strong' | 'eventual'; }, vector_encoding?: 'float' | 'base64'): { billing: query_billing; performance: query_performance; results: object[]; }`\n\n**post** `/v2/namespaces/{namespace}/query?stainless_overload=multiQuery`\n\nIssue multiple concurrent queries filter or search documents.\n\n### Parameters\n\n- `namespace: string`\n\n- `queries: { aggregate_by?: object; distance_metric?: 'cosine_distance' | 'euclidean_squared'; exclude_attributes?: string[]; filters?: object; group_by?: string[]; include_attributes?: boolean | string[]; limit?: number | { total: number; per?: { attributes: string[]; limit: number; }; }; rank_by?: object; top_k?: number; }[]`\n\n- `consistency?: { level?: 'strong' | 'eventual'; }`\n  The consistency level for a query.\n  - `level?: 'strong' | 'eventual'`\n    The query's consistency level.\n\n- `strong` - Strong consistency. Requires a round-trip to object storage to fetch the latest writes.\n- `eventual` - Eventual consistency. Does not require a round-trip to object storage, but may not see the latest writes.\n\n- `vector_encoding?: 'float' | 'base64'`\n  The encoding to use for vectors in the response.\n\n### Returns\n\n- `{ billing: { billable_logical_bytes_queried: number; billable_logical_bytes_returned: number; }; performance: { approx_namespace_size: number; cache_hit_ratio: number; cache_temperature: string; exhaustive_search_count: number; query_execution_ms: number; server_total_ms: number; }; results: { aggregation_groups?: object[]; aggregations?: object; rows?: object[]; }[]; }`\n  The result of a multi-query.\n\n  - `billing: { billable_logical_bytes_queried: number; billable_logical_bytes_returned: number; }`\n  - `performance: { approx_namespace_size: number; cache_hit_ratio: number; cache_temperature: string; exhaustive_search_count: number; query_execution_ms: number; server_total_ms: number; }`\n  - `results: { aggregation_groups?: object[]; aggregations?: object; rows?: { id: string | number; vector?: number[] | string; }[]; }[]`\n\n### Example\n\n```typescript\nimport Turbopuffer from '@turbopuffer/turbopuffer';\n\nconst client = new Turbopuffer();\n\nconst response = await client.namespaces.multiQuery({ namespace: 'namespace', queries: [{}] });\n\nconsole.log(response);\n```",
    "perLanguage": {
      "typescript": {
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://$TURBOPUFFER_REGION.turbopuffer.com/v2/namespaces/$NAMESPACE/explain_query \\\n    -X POST \\\n    -H \"Authorization: Bearer $TURBOPUFFER_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://$TURBOPUFFER_REGION.turbopuffer.com/v1/namespaces/$NAMESPACE/schema \\\n    -H \"Authorization: Bearer $TURBOPUFFER_API_KEY\""
      }
    }
  },
  {
  ...
  },
  {
    ...
    "response": "{ approx_logical_bytes: number; approx_row_count: number; created_at: string; encryption: { sse: boolean; } | { cmek: { key_name: string; }; }; index: { status: 'up-to-date'; } | { status: 'updating'; unindexed_bytes: number; }; schema: object; updated_at: string; pinning?: { replicas?: number; }; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://$TURBOPUFFER_REGION.turbopuffer.com/v1/namespaces/$NAMESPACE/metadata \\\n    -H \"Authorization: Bearer $TURBOPUFFER_API_KEY\""
      }
    }
  },
  {
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://$TURBOPUFFER_REGION.turbopuffer.com/v1/namespaces/$NAMESPACE/hint_cache_warm \\\n    -H \"Authorization: Bearer $TURBOPUFFER_API_KEY\""
      }
    }
  },
  {
  ...
  },
  {
    ...
    "response": "{ avg_ann_count: number; avg_exhaustive_count: number; avg_recall: number; ground_truth?: { nearest_neighbors: object[]; query_vector: number[]; }[]; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://$TURBOPUFFER_REGION.turbopuffer.com/v1/namespaces/$NAMESPACE/_debug/recall \\\n    -X POST \\\n    -H \"Authorization: Bearer $TURBOPUFFER_API_KEY\""
      }
    }
  },
  {
