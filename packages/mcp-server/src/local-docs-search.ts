...
const EMBEDDED_METHODS: MethodEntry[] = [
  ...
  },
  {
    ...
    params: [
      'namespace: string;',
      "queries: { aggregate_by?: object; distance_metric?: 'cosine_distance' | 'euclidean_squared'; exclude_attributes?: string[]; filters?: object; group_by?: object[]; include_attributes?: boolean | string[]; limit?: number | { total: number; per?: { attributes: string[]; limit: number; }; }; rank_by?: object; top_k?: number; }[];",
      "consistency?: { level?: 'strong' | 'eventual'; };",
      'rerank_by?: object;',
      "vector_encoding?: 'float' | 'base64';",
    ],
