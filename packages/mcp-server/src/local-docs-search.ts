...
const EMBEDDED_METHODS: MethodEntry[] = [
  ...
  },
  {
    ...
    params: [
      'namespace: string;',
      "queries: { aggregate_by?: object; compute_attributes?: object; distance_metric?: 'cosine_distance' | 'euclidean_squared'; exclude_attributes?: string[]; filters?: object; group_by?: object[]; include_attributes?: boolean | string[]; limit?: number | { total: number; per?: { attributes: string[]; limit: number; }; }; rank_by?: object; top_k?: number; }[];",
      "consistency?: { level?: 'strong' | 'eventual'; };",
      'rerank_by?: object;',
      "vector_encoding?: 'float' | 'base64';",
    ],
    ...
    markdown:
      "## multi_query\n\n`client.namespaces.multiQuery(namespace: string, queries: { aggregate_by?: object; compute_attributes?: object; distance_metric?: 'cosine_distance' | 'euclidean_squared'; exclude_attributes?: string[]; filters?: object; group_by?: object[]; include_attributes?: boolean | string[]; limit?: number | object; rank_by?: object; top_k?: number; }[], consistency?: { level?: 'strong' | 'eventual'; }, rerank_by?: object, vector_encoding?: 'float' | 'base64'): { billing: query_billing; performance: query_performance; results: object[]; }`\n\n**post** `/v2/namespaces/{namespace}/query?stainless_overload=multiQuery`\n\nIssue multiple concurrent queries filter or search documents.\n\n### Parameters\n\n- `namespace: string`\n\n- `queries: { aggregate_by?: object; compute_attributes?: object; distance_metric?: 'cosine_distance' | 'euclidean_squared'; exclude_attributes?: string[]; filters?: object; group_by?: object[]; include_attributes?: boolean | string[]; limit?: number | { total: number; per?: { attributes: string[]; limit: number; }; }; rank_by?: object; top_k?: number; }[]`\n\n- `consistency?: { level?: 'strong' | 'eventual'; }`\n  The consistency level for a query.\n  - `level?: 'strong' | 'eventual'`\n    The query's consistency level.\n\n- `strong` - Strong consistency. Requires a round-trip to object storage to fetch the latest writes.\n- `eventual` - Eventual consistency. Does not require a round-trip to object storage, but may not see the latest writes.\n\n- `rerank_by?: object`\n  How to combine the rows returned by each sub-query into a single ranked list.\n\n- `vector_encoding?: 'float' | 'base64'`\n  The encoding to use for vectors in the response.\n\n### Returns\n\n- `{ billing: { billable_logical_bytes_queried: number; billable_logical_bytes_returned: number; }; performance: { approx_namespace_size: number; cache_hit_ratio: number; cache_temperature: string; exhaustive_search_count: number; query_execution_ms: number; server_total_ms: number; }; results: { aggregation_groups?: object[]; aggregations?: object; rows?: object[]; }[]; }`\n  The result of a multi-query.\n\n  - `billing: { billable_logical_bytes_queried: number; billable_logical_bytes_returned: number; }`\n  - `performance: { approx_namespace_size: number; cache_hit_ratio: number; cache_temperature: string; exhaustive_search_count: number; query_execution_ms: number; server_total_ms: number; }`\n  - `results: { aggregation_groups?: object[]; aggregations?: object; rows?: { id: string | number; vector?: number[] | string; }[]; }[]`\n\n### Example\n\n```typescript\nimport Turbopuffer from '@turbopuffer/turbopuffer';\n\nconst client = new Turbopuffer();\n\nconst response = await client.namespaces.multiQuery({ namespace: 'namespace', queries: [{}] });\n\nconsole.log(response);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    params: ['namespace: string;'],
    response:
      "{ approx_logical_bytes: number; approx_row_count: number; created_at: string; encryption: { key_name: string; mode: 'customer-managed'; } | { mode: 'default'; }; index: { status: 'up-to-date'; } | { status: 'updating'; unindexed_bytes: number; }; schema: object; updated_at: string; pinning?: { replicas?: number; }; sharding?: { num_shards: number; }; }",
    markdown:
      "## metadata\n\n`client.namespaces.metadata(namespace: string): { approx_logical_bytes: number; approx_row_count: number; created_at: string; encryption: encryption; index: object | object; schema: object; updated_at: string; pinning?: pinning_config; sharding?: sharding_config; }`\n\n**get** `/v2/namespaces/{namespace}/metadata`\n\nGet metadata about a namespace.\n\n### Parameters\n\n- `namespace: string`\n\n### Returns\n\n- `{ approx_logical_bytes: number; approx_row_count: number; created_at: string; encryption: { key_name: string; mode: 'customer-managed'; } | { mode: 'default'; }; index: { status: 'up-to-date'; } | { status: 'updating'; unindexed_bytes: number; }; schema: object; updated_at: string; pinning?: { replicas?: number; }; sharding?: { num_shards: number; }; }`\n  Metadata about a namespace.\n\n  - `approx_logical_bytes: number`\n  - `approx_row_count: number`\n  - `created_at: string`\n  - `encryption: { key_name: string; mode: 'customer-managed'; } | { mode: 'default'; }`\n  - `index: { status: 'up-to-date'; } | { status: 'updating'; unindexed_bytes: number; }`\n  - `schema: object`\n  - `updated_at: string`\n  - `pinning?: { replicas?: number; }`\n  - `sharding?: { num_shards: number; }`\n\n### Example\n\n```typescript\nimport Turbopuffer from '@turbopuffer/turbopuffer';\n\nconst client = new Turbopuffer();\n\nconst namespaceMetadata = await client.namespaces.metadata({ namespace: 'namespace' });\n\nconsole.log(namespaceMetadata);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    params: ['namespace: string;', 'source_namespace: string;'],
    response:
      "{ billing: { billable_logical_bytes_written: number; query?: query_billing; }; message: string; rows_affected: number; status: 'OK'; deleted_ids?: string | number[]; patched_ids?: string | number[]; performance?: { server_total_ms: number; }; rows_deleted?: number; rows_patched?: number; rows_remaining?: boolean; rows_upserted?: number; upserted_ids?: string | number[]; }",
    markdown:
      "## branch_from\n\n`client.namespaces.branchFrom(namespace: string, source_namespace: string): { billing: write_billing; message: string; rows_affected: number; status: 'OK'; deleted_ids?: id[]; patched_ids?: id[]; performance?: write_performance; rows_deleted?: number; rows_patched?: number; rows_remaining?: boolean; rows_upserted?: number; upserted_ids?: id[]; }`\n\n**post** `/v2/namespaces/{namespace}?stainless_overload=branchFrom`\n\nCreates an instant, copy-on-write clone of a namespace.\n\n### Parameters\n\n- `namespace: string`\n\n- `source_namespace: string`\n  The namespace to create an instant, copy-on-write clone of.\n\n### Returns\n\n- `{ billing: { billable_logical_bytes_written: number; query?: query_billing; }; message: string; rows_affected: number; status: 'OK'; deleted_ids?: string | number[]; patched_ids?: string | number[]; performance?: { server_total_ms: number; }; rows_deleted?: number; rows_patched?: number; rows_remaining?: boolean; rows_upserted?: number; upserted_ids?: string | number[]; }`\n  The response to a successful write request.\n\n  - `billing: { billable_logical_bytes_written: number; query?: { billable_logical_bytes_queried: number; billable_logical_bytes_returned: number; }; }`\n  - `message: string`\n  - `rows_affected: number`\n  - `status: 'OK'`\n  - `deleted_ids?: string | number[]`\n  - `patched_ids?: string | number[]`\n  - `performance?: { server_total_ms: number; }`\n  - `rows_deleted?: number`\n  - `rows_patched?: number`\n  - `rows_remaining?: boolean`\n  - `rows_upserted?: number`\n  - `upserted_ids?: string | number[]`\n\n### Example\n\n```typescript\nimport Turbopuffer from '@turbopuffer/turbopuffer';\n\nconst client = new Turbopuffer();\n\nconst response = await client.namespaces.branchFrom({ namespace: 'namespace', source_namespace: 'source_namespace' });\n\nconsole.log(response);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    params: [
      'namespace: string;',
      'source_namespace: string;',
      "dest_encryption?: { key_name: string; mode: 'customer-managed'; } | { mode: 'default'; };",
